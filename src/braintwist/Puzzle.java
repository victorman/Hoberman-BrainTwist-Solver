...
public class Puzzle {
	...
	public Puzzle(Point[] p){
		...
		tri[0] = new Triangle(p[0],p[3],p[11]);
		tri[1] = new Triangle(p[1],p[8],p[4]);
		tri[2] = new Triangle(p[10],p[6],p[2]);
		tri[3] = new Triangle(p[9],p[7],p[5]);

		tetra1 = new Tetrahedron(tri[0],tri[1],tri[2],tri[3]);
		tetra2 = new Tetrahedron(tri[3],tri[5],tri[6],tri[7]);
	}
}
